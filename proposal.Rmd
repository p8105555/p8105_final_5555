...
project_variables =
   data.frame(
    substance_use = c( "alcohol use", "drug use", "smoking", "smoking" , " smoking"),
    data_source = c("alcohol use", "drug use" , "smoking_cigaratte use", "Cotinie and Hydroxycotinine-Serum" , "cotinine, Hydroxycotinine & Other Nocotine Metabolites and Analogs_Urine"),
    variable_name = c("P_ALQ/ALQ_I", "DUQ_J/DUQ_I", "SMQ_J/SMQ_I", "COT_J/COT_I", "UCOT_J/UCOT_I")
  )
```
